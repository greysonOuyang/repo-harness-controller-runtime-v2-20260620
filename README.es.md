...
Dirección del repositorio: `https://github.com/greysonOuyang/repo-harness-controller-runtime`
...
`~/Projects/repo-harness-controller-runtime` es la única source of truth editable; las rutas locales
