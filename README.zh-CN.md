...
<p align="center">
  <img src="docs/images/repo-harness-banner-cn.svg" alt="repo-harness 横幅，展示 ChatGPT 到 Controller 到 Repo 到 Agent 的协作链路" width="1280">
</p>

<!-- Legacy hero path kept in source for README DX continuity: docs/images/repo-harness-gptpro-cn.png -->
...
仓库地址：`https://github.com/greysonOuyang/repo-harness-controller-runtime`
...
<p align="center">
  <img src="docs/images/repo-harness-controller-flow.svg" alt="repo-harness 中 ChatGPT → Controller → Repo → Agent 的架构图" width="1280">
</p>

这张图的可编辑源文件在 [`assets/branding/repo-harness-controller-flow.mmd`](assets/branding/repo-harness-controller-flow.mmd)。
...
Release notes 见 [`docs/CHANGELOG.md`](docs/CHANGELOG.md)，当前版本线是 `1.4.0`。
...
`~/Projects/repo-harness-controller-runtime` 是唯一可编辑 source of truth；本地 Claude/Codex 路径
